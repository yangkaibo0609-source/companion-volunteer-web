...
export const volunteerMessages: VolunteerMessage[] = [
  { id: '01', identity: '中传志联志愿者1', avatar: avatar01, answer: '没有“真不想去了”的念头。偶尔活动太早了会觉得不想起，但跟活动本身无关。' },
  { id: '02', identity: '中传三农', avatar: avatar02, answer: '有过“不想去了”的念头。后期真正没有再去是因为机构刚开始做公益，后来面向心智障碍家庭开始收费，觉得本来是公益机构要帮助心智障碍家庭，收费之后就不太想去做了。' },
  { id: '03', identity: '中传志联志愿者2', avatar: avatar03, answer: '有过“不想去了”的念头——学校事情多、作业多、课多，叠加志愿活动也多，机构离学校远来回两小时，觉得很折腾很累。但只是一个念头，因为知道自己当初为什么报名，不只是责任心，本身也对这个活动有很深的情感。' },
  { id: '04', identity: '星星雨长期志愿者', avatar: avatar04, answer: '有过“不想去了”的念头，但不强烈。有时会有失望——期待他们给予情感回应但很多时候不会按期待方式回应。但他们后来给了很多惊喜，很多次用自己的方式回应信任和共情。' },
  { id: '05', identity: '草桥长期志愿者', avatar: avatar05, answer: '没有“不想去了”的念头。' },
  { id: '06', identity: '草桥志愿者', avatar: avatar06, answer: '没有“不想去了”的念头。很清楚做完这几次以后就没有机会再遇到了，每一次都当做最后一次志愿活动，能多参加一次就尽可能参加。' },
  { id: '07', identity: '自由职业者', avatar: avatar07, answer: '有请假，是因为时间安排不过来，跟其他原因无关。' },
  { id: '08', identity: '社会在职人员', avatar: avatar08, answer: '如果累积到极点想暂停或退出，最主要原因是时间精力冲突（学业/工作太忙）。' },
]
